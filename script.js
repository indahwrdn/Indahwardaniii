...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Halo Sayangnyaa akuu", "Aku punya pertanyaan niiii", "question").then(function () {
    Swal.fire("Jawab jujur yaa sayangg").then(function () {
      Swal.fire("Awasss ajaa yaaa kalooo boong", "", "error").then(function () {

        const {
          value: name
        } = Swal.fire({
          title: 'Isii nama kamuu yaaa',
          input: 'text',
          inputLabel: '',
          showCancelButton: true,
          inputValidator: (value) => {
            if (!value) {
              return 'isi duluu dongg yangg :('
            } else {
              nama = value;
            }
          }
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Makasih banget ya Yangg udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhuhuhuhuhu iya ${sender} juga kangen bangett samaaa ${nama} , makasihhh yaa sayang :)`).then(function () {
